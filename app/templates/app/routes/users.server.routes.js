...
module.exports = function (app) {
    ...
    app.route('/users/profiles/:userId')
        .get(users.read)
        .put(users.requiresLogin, users.updateCompleteProfile)
        .delete(users.requiresLogin, users.delete);

    //.put(users.requiresLogin, users.hasAuthorization, users.updateCompleteProfile)
